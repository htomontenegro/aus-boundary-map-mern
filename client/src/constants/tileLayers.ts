...
export const TILE_LAYERS: TileLayerDef[] = [
  ...
  },
  {
    ...
    description: 'Clean minimal light style',
  },
  {
    id: 'carto-dark',
    label: 'CartoDB Dark',
  ...
  },
  {
    ...
    attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors &copy; <a href="https://carto.com/attributions">CARTO</a>',
    description: 'Colorful mid-detail',
  },
  {
    id: 'esri-satellite',
  ...
  },
  {
    ...
    description: 'Topographic contours',
  },
  {
    id: 'stadia-smooth',
    label: 'Stadia Smooth',
...
export function getTileLayer(id: string): TileLayerDef {
  return TILE_LAYERS.find(t => t.id === id) ?? TILE_LAYERS[0];
}
